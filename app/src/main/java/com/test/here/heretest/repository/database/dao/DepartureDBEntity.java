...
public class DepartureDBEntity implements Departure {
    ...
    public DepartureDBEntity(final long rideId, @NonNull final String lineNumber, @NonNull final String direction, final long time, @NonNull final String timezone) {
        this.rideId = rideId;
